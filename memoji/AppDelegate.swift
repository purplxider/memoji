...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if UserDefaults.standard.object(forKey: "kpop") == nil {
            ...
            questions.append(Question(emoji: "🐟🦷", length: 2, answer: ["어", "이"]))
            ...
            questions.append(Question(emoji: "💑❌", length: 5, answer: ["사", "랑", "하", "지", "마"]))
            ...
            questions.append(Question(emoji: "🌑🌒🌓🌔🌕💃", length: 9, answer: ["달", "이", ".", "차", "오", "른", "다", "가", "자"]))
            ...
            questions.append(Question(emoji: "👃👃🍚", length: 7, answer: ["K", "O", "K", "O", ".", "B", "O", "P"]))
            ...
            questions.append(Question(emoji: "✌📗🔚🔁✍☀️", length: 12, answer: ["이", "소", "설", "의", "끝", "을", "다", "시", "써", "보", "려", "해"]))
            ...
            questions.append(Question(emoji: "🗣🛣", length: 5, answer: ["말", "하", "는", "대", "로"]))
            ...
            questions.append(Question(emoji: "🍊☀️🍊🌙", length: 6, answer: ["오", "랜", "날", "오", "랜", "밤"]))
            ...
            questions.append(Question(emoji: "👍👍👍👍👍👍", length: 6, answer: ["아", "주", "N", "I", "C", "E"]))
