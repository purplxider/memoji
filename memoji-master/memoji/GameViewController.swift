...
class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
            ...
            emoji = question.list[questionNumber].emoji
            answerPool = question.list[questionNumber].answerPool
            answer = question.list[questionNumber].answer
            answerLength = question.list[questionNumber].length
